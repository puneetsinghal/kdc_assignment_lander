...
init_default_parameters( SIM *s )
{
  ...
  s->alien_I[XX][YY] = 1.142857142857143;
  s->alien_I[XX][ZZ] = 1.714285714285714;

  s->alien_I[YY][XX] = 1.142857142857143;
  s->alien_I[YY][YY] = 5.362637362637362;
  s->alien_I[YY][ZZ] = 2.043956043956044;

  s->alien_I[ZZ][XX] = 1.714285714285714;
  s->alien_I[ZZ][YY] = 2.043956043956044;
